...
| `DemoShop.Domain.Tests` | C# | NUnit | `[TestCase]`, `[Ignore]`, `[Explicit]` (method + class level), a commented-out test |
...
| `checkout-e2e` | JS | Playwright | `test`, `test.skip`, `test.fixme` (counts as ignored), a commented-out test |
